...
const UpdateGroup = ({ handleGroupClose, groupOpen, groupInfo }) => {
                        ...
                        <Box sx={{ my: 2 }} style={{ fontFamily: `"Poppins", sans-serif` }}>
                            ...
                            <Box >
                                ...
                                <Box style={{ display: "flex", justifyContent: 'center' }}>
                                    {previewSource ? <>
                                        <img style={{ width: '100px', height: '100px', position: 'absolute', zIndex: '-1', borderRadius: '100%' }} src={previewSource || groupInfo?.chat?.img} alt="chosen" />
                                        ...
                                        <> <img style={{ width: '100px', height: '100px', position: 'absolute', zIndex: '-1', borderRadius: '100%' }} src={groupInfo?.chat?.img} alt="chosen" />
                                            <label className="browseFile" style={{ opacity: 'none', background: 'transparent', padding: '40px', border: 'none' }}>
                                                <input sx={{ opacity: 'none', color: 'white', height: '100px', padding: '30px 30px!important' }} onChange={(e) => setSelected(e)} type="file" />
                                                Browse File
                                            </label></>}
