...
const UnPinInfo = ({ note, mode, unPinPage, setUnPinCount }) => {
    ...
    return (
        <div className="notes-card-style">
            ...
            {singleNoteInfo && <UpdateNote notePage={unPinPage} setNoteCount={setUnPinCount} mode={mode} singleNoteInfo={singleNoteInfo} open={open} handleOpen={handleOpen} handleClose={handleClose} />}
        </div>
    );
};

export default UnPinInfo;
