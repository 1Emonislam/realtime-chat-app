...
export const getMessage = (chatId, token, search) => {
    return async (dispatch) => {
        ...
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/message/${chatId}?search=${search || ''}`, {
                method: 'GET',
                headers: {
...
export const sendMessage = (data, chatId, token, audio) => {
    return async (dispatch) => {
        ...
        try {
            ...
            fetch(`https://collaballsystem.herokuapp.com/api/message`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    "authorization": `Bearer ${token}`
...
export const sendAllUploadMessage = (data, chatId, token) => {
    return async (dispatch) => {
        ...
        try {
            //make sure all data array passing
            fetch(`https://collaballsystem.herokuapp.com/api/message/all/upload/${chatId}`, {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
...
export const deleteAllMessage = (chatId, token) => {
    ...
    return async (dispatch) => {
        ...
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/message/${chatId}`, {
                method: 'DELETE',
                headers: {
                    "Content-Type": "application/json",
                    "authorization": `Bearer ${token}`
...
export const noteCreate = (chatId, messageId, token) => {
    return async (dispatch) => {
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/note`, {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json",
                    "authorization": `Bearer ${token}`
