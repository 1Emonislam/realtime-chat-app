...
export const getGroupChatData = (token, status, page, limit) => {
    return (dispatch) => {
        ...
        fetch(`https://collaballsystem.herokuapp.com/api/chat?status=${status || ''}&page=${page || 1}&limit=${limit || 10}`, {
            method: 'GET',
            headers: {
...
export const postGroupChatData = (data, token, reset) => {
    ...
    return async (dispatch) => {
        ...
        try {
            fetch('https://collaballsystem.herokuapp.com/api/chat/group/create', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const groupInvite = (chatId, token, handleCopy, email) => {
    return async (dispatch) => {
        ...
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/invite/gen`, {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const inviteLinkVerify = (chatId, userId, invitedPerson, token) => {
    return async (dispatch) => {
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/invite/verify/${token}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const groupMemberAdd = (chatId, userCollection, token, handleCopy) => {
    return async (dispatch) => {
        ...
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/addTo`, {
                method: 'PUT',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const groupMemberRemove = (chatId, userId, token) => {
    return async (dispatch) => {
        ...
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/member/removeTo/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const groupDelete = (chatId, token) => {
    return async (dispatch) => {
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/delete`, {
                method: 'Delete',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
...
export const groupUpdate = (data, token, reset) => {
    return async (dispatch) => {
        try {
            fetch(`https://collaballsystem.herokuapp.com/api/chat/group/rename`, {
                method: 'PUT',
                headers: {
                    'Content-Type': "application/json",
                    "authorization": `Bearer ${token}`
