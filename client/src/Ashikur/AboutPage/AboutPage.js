            ...
            <Box className={styles.mainAboutSection}>
                ...
                {value === 'one' ? <Box sx={{ mt: 3 }}>
                    ...
                    <Box>
                        <IconButton sx={{ p: 0 }} aria-label="Example">
                            {/* <FontAwesomeSvgIcon icon={faEllipsisV} /> */}
                            <FacebookOutlinedIcon sx={{ color: `${theme === 'dark' ? '#ec407a' : '#420ba1'}`, borderRadius: 15, fontSize: 22, mr: 1 }} />
                        </IconButton>
                        <IconButton sx={{ p: 0 }} aria-label="Example">
                            {/* <FontAwesomeSvgIcon icon={faEllipsisV} /> */}
                            <TwitterIcon sx={{ color: `${theme === 'dark' ? '#ec407a' : '#420ba1'}`, borderRadius: 15, fontSize: 22, mr: 1 }} />
                        </IconButton>
                        <IconButton sx={{ p: 0 }} aria-label="Example">
                            {/* <FontAwesomeSvgIcon icon={faEllipsisV} /> */}
                            <YouTubeIcon sx={{ color: `${theme === 'dark' ? '#ec407a' : '#420ba1'}`, borderRadius: 15, fontSize: 22, mr: 1 }} />
                        </IconButton>
                        <IconButton sx={{ p: 0 }} aria-label="Example">
                            {/* <FontAwesomeSvgIcon icon={faEllipsisV} /> */}
                            <InstagramIcon sx={{ color: `${theme === 'dark' ? '#ec407a' : '#420ba1'}`, borderRadius: 15, fontSize: 22, mr: 1 }} />
                        </IconButton>
                        <IconButton sx={{ p: 0 }} aria-label="Example">
                            {/* <FontAwesomeSvgIcon icon={faEllipsisV} /> */}
